#!/usr/bin/env python3
"""
Build the Pokémon DenZ MOBILE app — a single self-contained .html you AirDrop /
...
Output: "Pokémon DenZ — Deck.html" in POKECHEST_HOME.
"""
...
OUT = os.path.join(HOME, "Pokémon DenZ — Deck.html")
